<template>
  <div class="sales-board">
      ...
      <my-dialog :isShow="isShowErrDialog" @onClose="hideErrDialog">
        支付失败！
      </my-dialog>
      <check-order :is-show-check-dialog="isShowCheckOrder" :order-id="orderId" n-close-check-dialog="hideCheckOrder"></check-order>
  </div>
</template>
